...
export const CONTACT_METHODS = [
    {
        id: 'email',
        url: `mailto:${PERSOONLIJKE_INFO.Email}`,
        ariaLabel: 'Email',
        titel: 'Stuur me een mailtje!',
        icon: 'IconEmail'
    },
    {
        id: 'linkedin',
        url: 'https://www.linkedin.com/in/rob-stolte/',
        ariaLabel: 'LinkedIn',
        titel: 'Bekijk mijn LinkedIn profiel!',
        icon: 'IconLinkedin'
    },
    {
        id: 'github',
        url: 'https://github.com/RobStolte',
        ariaLabel: 'GitHub',
        titel: 'Bekijk mijn GitHub profiel!',
        icon: 'IconGithub'
    },
    {
        id: 'twitter',
        url: 'https://twitter.com/pomp0m',
        ariaLabel: 'Twitter',
        titel: 'Bekijk mijn Twitter profiel!',
        icon: 'IconTwitter'
    },
    {
        id: 'paypal',
        url: 'https://paypal.me/RobStolte',
        ariaLabel: 'PayPal',
        titel: 'Doneer via PayPal!',
        icon: 'IconPaypal'
    }
]
